...
% oblique projection: screen = (x + 0.35 y, z + 0.5 y)
% \cub{x0}{x1}{y0}{y1}{z0}{z1}{color}: front, top, right faces
\newcommand{\cub}[7]{%
  \fill[#7!45!white,draw=black,line width=0.35pt]
    ({#1+0.35*#3},{#5+0.5*#3}) -- ({#2+0.35*#3},{#5+0.5*#3}) --
    ({#2+0.35*#3},{#6+0.5*#3}) -- ({#1+0.35*#3},{#6+0.5*#3}) -- cycle;
  \fill[#7!22!white,draw=black,line width=0.35pt]
    ({#1+0.35*#3},{#6+0.5*#3}) -- ({#2+0.35*#3},{#6+0.5*#3}) --
    ({#2+0.35*#4},{#6+0.5*#4}) -- ({#1+0.35*#4},{#6+0.5*#4}) -- cycle;
  \fill[#7!62!gray,draw=black,line width=0.35pt]
    ({#2+0.35*#3},{#5+0.5*#3}) -- ({#2+0.35*#4},{#5+0.5*#4}) --
    ({#2+0.35*#4},{#6+0.5*#4}) -- ({#2+0.35*#3},{#6+0.5*#3}) -- cycle;}
% axes triad
\draw[->,gray] (-1.1,0.05) -- (-0.5,0.05) node[right,gray] {\scriptsize $x$};
\draw[->,gray] (-1.1,0.05) -- (-0.89,0.35) node[above,gray] {\scriptsize $y$};
\draw[->,gray] (-1.1,0.05) -- (-1.1,0.65) node[above,gray] {\scriptsize $z$};
% layer 0 (even, y-slots), back to front
\cub{0}{3}{2}{3}{0}{0.55}{gray}
\cub{0}{3}{1}{2}{0}{0.55}{gray}
\cub{0}{3}{0}{1}{0}{0.55}{gray}
% layer 1 (odd, x-slots), left to right
\cub{0}{1}{0}{3}{0.55}{1.1}{gray}
\cub{1}{2}{0}{3}{0.55}{1.1}{gray}
\cub{2}{3}{0}{3}{0.55}{1.1}{gray}
% the interesting stack
\cub{0}{3}{0}{1}{1.1}{1.65}{blue}   % lone side block
\cub{1}{2}{0}{3}{1.65}{2.2}{red}    % perpendicular single
\cub{0}{3}{0}{1}{2.2}{2.75}{blue}   % parallel L
\cub{1}{2}{0}{3}{2.75}{3.3}{red}    % perpendicular single
\cub{0}{3}{0}{1}{3.3}{3.85}{blue}   % parallel L (top)
% support-boundary plane y = 1
\fill[orange,opacity=0.06] (0.1,1.5) -- (3.6,1.5) -- (3.6,4.9) -- (0.1,4.9) -- cycle;
\draw[dashed,thick,orange!75!black] (0.1,1.5) -- (3.6,1.5) -- (3.6,4.9) -- (0.1,4.9) -- cycle;
\node[above,orange!75!black] at (1.85,4.9) {\small the support-boundary plane $y=1$};
% centre of mass of the four layers above, at (1.5, 1, mid-height)
\fill[orange!85!black] (1.85,3.25) circle (0.075);
\draw[orange!85!black,line width=0.5pt] (1.92,3.29) -- (4.3,4.1);
\node[anchor=west,align=left] at (4.3,4.1)
  {\small combined COM of the four layers\\\small above the lone block: \emph{exactly}\\\small on the plane};
\draw[line width=0.5pt] (2.0,2.95) -- (4.3,2.95);
\node[anchor=west] at (4.3,2.95) {\small perpendicular singles: $+\tfrac12$ each};
\draw[line width=0.5pt] (2.9,2.45) -- (4.3,2.35);
\node[anchor=west] at (4.3,2.35) {\small parallel \layer{L} blocks: $-\tfrac12$ each};
\draw[line width=0.5pt] (2.9,1.4) -- (4.3,1.6);
\node[anchor=west] at (4.3,1.6) {\small the lone side block};
\end{tikzpicture}
